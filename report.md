...
The cleaned question transcription is available in `question.txt`. The implementation is split into `src/question1.cpp` and `src/question2.cpp`.
...
Running `./question1` creates:

- `output/question1_summary.txt`
- `output/part1_bisection.csv`
- `output/part1_newton.csv`
- `output/part1_hybrid.csv`

Running `./question2` creates:

- `output/question2_summary.txt`
- `output/part2_guess1.csv`
- `output/part2_guess2.csv`
