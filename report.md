...
The cleaned question transcription is available in `question.txt`.
...
![Bisection history](output/plots/bisection_history.png)
...
![Newton history](output/plots/newton_history.png)
...
![Hybrid history](output/plots/hybrid_history.png)
...
The C++ program applies multivariable Newton-Raphson to the two starting guesses from the question.
